...
\subsection{Convexity}
    \begin{emphbox}
    	in convex set $\mathcal{C} \subset \R$, $f$ is convex, if $tf(\boldsymbol{x_2}+(1-t)f(\boldsymbol{x_1} \leq f(t\boldsymbol{x_2}+(1-t)\boldsymbol{x_1} \quad \forall \boldsymbol{x_1,x_2}\in \mathcal{C}, t\in[0,1]$
	\end{emphbox}
	...
	\begin{center}
	    \includegraphics[width = 0.7\columnwidth]{template-files/figures/convexity.png}
	\end{center}
...
\end{itemize}
\begin{center}
	    \includegraphics[width = 0.9\columnwidth]{template-files/figures/sphx_glr_plot_roc_001.png}
	\end{center}
...
\begin{center}
	    \includegraphics[width = 0.9\columnwidth]{template-files/figures/angular_distance_plot.png}
	\end{center}
\end{sectionbox}
...
\begin{center}
	    \includegraphics[width = 0.9\columnwidth]{template-files/figures/error_if_removed.png}
	\end{center}
\begin{center}
	    \includegraphics[width = 0.7\columnwidth]{template-files/figures/PCA_case1.png}
	\end{center}
\begin{center}
	    \includegraphics[width = 0.7\columnwidth]{template-files/figures/PCA_case2.png}
	\end{center}
\begin{center}
	    \includegraphics[width = 0.7\columnwidth]{template-files/figures/PCA_case3.png}#
	\end{center}
% DOCUMENT_END =================================================================
\end{document}
